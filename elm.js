...
if (typeof _evancz$elm_todomvc$Todo$main !== 'undefined') {
    _evancz$elm_todomvc$Todo$main(Elm['Todo'], 'Todo', {"types":{"unions":{"Todo.Msg":{"args":[],"tags":{"ChangeVisibility":["String"],"DeleteComplete":[],"UpdateField":["String"],"Check":["Int","Bool"],"Add":[],"CheckAll":["Bool"],"UpdateEntry":["Int","String"],"EditingEntry":["Int","Bool"],"NoOp":[],"Delete":["Int"]}}},"aliases":{},"message":"Todo.Msg"},"versions":{"elm":"0.18.0"}});
}
